...
// 96) Push the odd numbers from 9 through 1 to myArray using a for loop.
...
// 99) Change the while loop in the code to a do...while loop so the loop will push only the number 10 to myArray, and i will be equal to 11 when your code has finished running.
